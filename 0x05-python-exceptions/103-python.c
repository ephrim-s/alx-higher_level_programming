...
#include <string.h>
/**
 * print_python_bytes - displays items from python
 * @p: points to the PyObject p
 */
...
/**
 * print_python_float - displays python items
 * @p: points to the PyObject p
 */
...
/**
 * print_python_list - displays python items
 * @p: points to the PyObject p
 */
